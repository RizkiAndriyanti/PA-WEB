...
<body>
    ...
    <h3 id="judul-daftar">CART</h3>
    <a href="pesanan-user.php"><button class="tmbl-tambah">TAMBAH PESANAN</button></a>
    ...
    <div class="table">
        <table class="tabel-sepatu">
            ...
            <tr>
                <td><?=$i;?></td>
                <td nowrap><?= $row['nama_pemesan'];?></td>
                <td><?= $row['pesanan_produk'];?></td>
                <td><?= $row['ukuran_pesanan'];?></td>
                <td><?= $row['jumlah_pesanan'];?></td>
                <td><?= $row['harga_pesanan'];?></td>
                <td><?= $row['warna_pesanan'];?></td>
                <td><?= $row['alamat_pemesan'];?></td>

                <td class="edit">
                    <a href="editkeranjang.php?id=<?=$row['id'];?>">
                ...
                <td class="hapus">
                    <a href="hapuskeranjang.php?id=<?=$row['id'];?>">
                ...
                <td>
                    <a href="pembelian.php?id=<?=$row['id'];?>">
                    <button name="buy" class="beli">Buy</button>
                </td>
            </tr>
