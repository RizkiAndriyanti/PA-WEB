<?php 
    ...
    if(isset($_GET['id'])){
        $id = $_GET['id'];
        $result = mysqli_query($db, "SELECT * FROM registrasi WHERE id = '$id' ");
    ...
    if(isset($_POST['kirim'])){
        ...
        $update = mysqli_query($db, "UPDATE registrasi SET nama='$nama', pw='$pw', email='$email', nohp='$nohp', ttl='$ttl' WHERE id='$id'");
...
<body>
    ...
    <h1 class="judul-buatakun">EDIT DATA PELANGGAN</h1>
