...
<body>
    <div class="kontainer">
        ...
        <div class="main">
            ...
            <div class="tmbl">
                <a href="sepatu.php"><button class="tombol-2">SEPATU</button></a>
                <a href="pesanan.php"><button class="tombol-2">PESANAN</button></a>
                <a href="akunuser.php"><button class="tombol-2">DATA PELANGGAN</button></a>
            </div>
