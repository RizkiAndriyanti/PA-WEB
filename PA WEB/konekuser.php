...
if(isset($_POST['kirim'])){
    ...
    $user = $db->query("SELECT * FROM registrasi WHERE username='$username'");
    ...
    if($num_user > 0){
        ...
        if($pw == $konfirm){
            ...
            if (move_uploaded_file($tmp, 'profil/'.$newgambar)){
                $query = "INSERT INTO registrasi (nama,pw,email,nohp,ttl,username,gambar) VALUES ('$nama','$pw','$email','$nohp','$ttl','$username','$newgambar')";
